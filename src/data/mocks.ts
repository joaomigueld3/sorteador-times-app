...
export const MOCK_PLAYERS: Player[] = [
  { id: '1', name: 'Must (I. Fellows)', positions: ['ATA'], currentStats: { fisico: 90, habilidade: 100, defesa: 80 }, pin: '1234' },
  ...
  { id: '5', name: 'Lucas Guedes', positions: ['ATA', 'ZAG'], currentStats: { fisico: 90, habilidade: 90, defesa: 80 }, pin: '1234' },
  ...
  { id: '8', name: 'Ighor Honorato', positions: ['ATA', 'ZAG'], currentStats: { fisico: 60, habilidade: 90, defesa: 90 }, pin: '1234' },
  { id: '9', name: 'Caio Almeida', positions: ['ZAG'], currentStats: { fisico: 90, habilidade: 80, defesa: 90 }, pin: '1234' },
  { id: '10', name: 'Emanuel', positions: ['ATA', 'ZAG'], currentStats: { fisico: 90, habilidade: 70, defesa: 80 }, pin: '1234' },
  { id: '11', name: 'Heverton', positions: ['ZAG'], currentStats: { fisico: 80, habilidade: 80, defesa: 80 }, pin: '1234' },
  ...
  { id: '14', name: 'Juninho', positions: ['ATA'], currentStats: { fisico: 70, habilidade: 80, defesa: 60 }, pin: '1234' },
  ...
  { id: '21', name: 'Victor Hugo', positions: ['ATA'], currentStats: { fisico: 50, habilidade: 70, defesa: 70 }, pin: '1234' },

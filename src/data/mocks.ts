...
export const MOCK_PLAYERS: Player[] = [
  { id: '1', name: 'Must (I. Fellows)', positions: ['ATA'], currentStats: { fisico: 90, habilidade: 100, defesa: 70 }, pin: '1234' },
  ...
  { id: '5', name: 'Lucas Guedes', positions: ['ATA', 'ZAG'], currentStats: { fisico: 100, habilidade: 90, defesa: 70 }, pin: '1234' },
